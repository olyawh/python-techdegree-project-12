...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('JavaScript', 'JavaScript'), ('SQL', 'SQL Databases'), ('Python', 'Python'), ('CSS', 'CSS'), ('Design', 'Design'), ('UX', 'User experience')], default='JavaScript', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
